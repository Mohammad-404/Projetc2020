<?php
    ...
    if (isset($_POST['sub'])) {
        ...
        $x->CreateCategory($name_cat,$description_cat,$name_image);
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="manegar_category.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input name="description_cat" type="text" class="form-control cc-name valid">
                                             ...
                                             <?php
                                                ...
                                                while ($row = $printer->fetch_assoc()) {
                                                    echo"<tr>";
                                                        ...
                                                        echo"</td>";
                                                        echo"<td>";
                                                            echo "<img src=uploadimages/".$row['cat_image']." width=100px height=100px>";
                                                        echo"</td>";

                                                        echo"<td> 
                                                           <a href='edit_category.php?id={$row['cat_id']}'class='btn btn-primary'>Edit</a>
                                                         </td>";

                                                        echo"<td> 
                                                           <a href='delete_category.php?id={$row['cat_id']}'class='btn btn-danger'>Delete</a>
                                                         </td>";
                                                    echo"</tr>";
                                                }
                                            ?>
